...
<div id="main-content-wp" class="list-post-page">
    <div class="wrap clearfix">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-operation ">
                                            <li><a href="../?modules=products&controllers=index&action=detail&id=<?php echo $value['product_id']; ?>#comment-<?php echo $value['id']?>" title="Trả lời" class="edit"><i class="fa fa-reply" aria-hidden="true"></i></a></li>
                                            <li><a onclick="return Del()" href="?modules=comment&controllers=index&action=delete&id=<?php echo $value['id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                </tr>
                                <?php }; ?>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <ul id="list-paging" class="fl-right">
                        ...
                        <li>
                            <a <?php if($i == $data['2']) echo 'style="background-color: green;color:white; border-radius:300px;"';  ?>  href="?modules=comment&controllers=index&action=list&page=<?php echo $i; ?>" title=""><?php echo $i; ?></a>
                        </li>
                        <?php }; ?>
                    </ul>
                </div>
        ...
        <script>
            function Del() {
                return confirm ("Bạn có chắn chắn xóa comment này không?");
            }
        </script>         
