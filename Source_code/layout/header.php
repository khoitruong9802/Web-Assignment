        ...
        <div id="container">
            <div id="header-wp">
                    ...
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    <a href="?modules=users&action=index" title=""><?php if (!empty($_SESSION['fullname'])) echo $_SESSION['fullname'];
                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner">
                        <a href="?modules=home" title="" id="logo" class="fl-left"><img src="public/images/smart-mobi2.png" style="height: 60px; border-radius: 5px"/></a>
